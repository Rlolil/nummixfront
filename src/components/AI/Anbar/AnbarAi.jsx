...
//           <h3 className="text-gray-700 font-medium mb-2">{t("pages.ai.warehouse.cashFlow.title")}</h3>
//           <p className="text-gray-400 text-sm mb-3">{t("pages.ai.warehouse.cashFlow.subtitle")}</p>
...
//           <div>
//             <h3 className="text-gray-700 font-medium mb-2">{t("pages.ai.warehouse.expenseDistribution.title")}</h3>
//             <p className="text-gray-400 text-sm mb-3">{t("pages.ai.warehouse.expenseDistribution.subtitle")}</p>
//           </div>
    ...
    <div className="container mx-auto px-2 py-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {data.stats.map((s, i) => (
          <div
            key={i}
            className="bg-white dark:bg-zinc-700 border border-gray-300 dark:border-gray-700 rounded-xl shadow-sm p-5 flex justify-between items-center"
          >
            <div className="space-y-3">
            ...
            <div className="bg-gray-100 dark:bg-zinc-800 p-3 rounded-full">{s.icon}</div>
          </div>
        ))}
      </div>

      <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl shadow-sm p-5 mb-6">
        <Xeberdarliq />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 flex flex-col">
          <h3 className="text-gray-700 dark:text-gray-100 font-medium mb-2">{t("pages.ai.warehouse.cashFlow.title")}</h3>
          <p className="text-gray-400 dark:text-gray-400 text-sm mb-3">{t("pages.ai.warehouse.cashFlow.subtitle")}</p>
          <div className="bg-orange-50 dark:bg-orange-900/30 text-sm text-gray-800 dark:text-gray-100 p-3 rounded-lg mt-4">
            <strong>{t("pages.ai.common.aiAnalysisLabel")}</strong> {t("pages.ai.warehouse.cashFlow.aiText")}
          </div>
          <Chart1 />
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
          <div>
            <h3 className="text-gray-700 dark:text-gray-100 font-medium mb-2">{t("pages.ai.warehouse.expenseDistribution.title")}</h3>
            <p className="text-gray-400 dark:text-gray-400 text-sm mb-3">{t("pages.ai.warehouse.expenseDistribution.subtitle")}</p>
          </div>
          <div className="flex flex-col items-center justify-center mt-10">
            <Chart2 />
          </div>
