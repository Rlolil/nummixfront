...
const ProductCustomer = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-5 border border-gray-300 dark:border-gray-700">
        ...
        <div className="space-y-3">
          {products.map((item, index) => (
            <div
              key={index}
              className="flex items-center justify-between border border-gray-300 dark:border-gray-700 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-700/40 transition"
            >
              ...
              <div className="text-right">
                <p className="font-bold text-gray-800 dark:text-gray-100">{item.price}</p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{c.orders}</p>
                </div>
              </div>
              <p className="font-bold text-gray-800 dark:text-gray-100">{c.price}</p>
            </div>
          ))}
        </div>
      </div>
