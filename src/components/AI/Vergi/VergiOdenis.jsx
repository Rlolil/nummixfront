    ...
    return (
        <div className="container mx-auto py-4">
            <div className="bg-white border border-gray-300 rounded-xl shadow-sm p-5 mb-6">
                ...
                <p className="text-gray-500 mb-5">Ödənilməli vergi və ayırmalar</p>
                        ...
                        >
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <div className="text-right">
                                    ...
                                    <span
                                        className={`text-xs px-2 py-1 rounded-full ${tax.remainingDays <= 3
                            ...
                            {tax.delay && (
                                <div className="mt-3 text-sm text-gray-700 bg-white/70 p-3 rounded-lg border border-gray-100">
                                    <strong>AI Xəbardarlıq:</strong> Gecikən carima: {tax.delay}
                                </div>
                            )}

                            {/* Düymələr */}
                            <div className="flex items-center gap-3 mt-4">
                                <button className="bg-blue-600 w-[600px] hover:bg-blue-700 text-white font-medium px-5 py-2 rounded-lg transition">
                                    İndi Ödə
                                </button>
                                <button className="border bg-white border-gray-300 w-[600px] hover:bg-gray-100 text-gray-700 font-medium px-5 py-2 rounded-lg transition">
                                    Xatırlat
                                </button>
                            </div>
                        </div>
