  ...
  return (
    <div className="rounded-xl">
      <div className='block md:hidden text-[16px] mb-5'>
        <h1 className='font-semibold'>Bank Əməliyyatları</h1>
        <h1 className='text-[#717182]'>Bank hesablarının hərəkəti</h1>
      </div>
      ...
      <div className="md:hidden flex flex-col gap-4">
        {kassaData.map((item, i) => (
          <div key={i} className="border border-gray-300 rounded-xl p-4 shadow-sm">
            ...
            <div className="flex justify-between items-center mb-2">
              <span className="text-gray-600 text-sm">Hesab:</span>
              <span>{item.hes}</span>
            </div>
            <div className="flex justify-between items-center mb-2">
