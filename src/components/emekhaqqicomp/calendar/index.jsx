  ...
  return (
    <div className="space-y-6 my-4 text-[#001233]">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xl text-[#023E7D]">{t('pages.hr.calendar.title', { defaultValue: 'Calendar' })}</p>
          <p className="text-[#7D8597]">{t('pages.hr.calendar.subtitle', { defaultValue: 'Important dates and reminders' })}</p>
        </div>
        <div>
          {modalOpen && (
          ...
          <button
            ...
            className="bg-[#0466CB] hover:bg-[#0453A4] rounded-xl p-2 flex items-center gap-2"
          >
      ...
      <div className="grid md:grid-cols-[2fr_1fr]  gap-4 grid-cols-1">
        <div className="border border-[#33415C] bg-[#FFFFFF] rounded-xl shadow-sm p-4"><EventCalendar /></div>
