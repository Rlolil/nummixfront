...
function VatDeclaration({ taxData, totalInput, totalOutput, vatPayable }) {
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 max-w-4xl mx-auto border border-[#33415C] rounded-xl shadow-sm bg-[#fff] dark:bg-[#001233] dark:text-white text-[#001233]">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
        <div>
          <h3 className="text-base sm:text-lg md:text-xl font-medium dark:text-white text-[#023E7D]">{t('pages.accounting.taxReports.tabs.vat')}</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-2 sm:mt-0">
          <button className="flex items-center gap-2 px-4 py-2 border border-[#33415C] rounded dark:bg-[#002855] bg-[#FFFFFF] hover:bg-[#0453A4] hover:text-white transition-colors text-xs sm:text-sm">
            <AiOutlineDownload className="w-4 h-4 sm:w-5 sm:h-5" /> {t('common.export') || 'Export'}
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-[#0466CB] dark:bg-[#0453A4] text-white rounded hover:bg-[#0453A4] text-xs sm:text-sm">
            <AiOutlineSend className="w-4 h-4 sm:w-5 sm:h-5" /> {t('pages.accounting.taxReports.actions.submitToEgov')}
          </button>
        </div>
      </div>
      <div className="mb-4 sm:mb-6">
        <h3 className="text-base sm:text-lg md:text-xl font-medium mb-2 dark:text-white  text-[#023E7D]">{t('pages.accounting.taxReports.vat.output')}</h3>
      ...
      <div className="mb-4 sm:mb-6">
        <h3 className="text-base sm:text-lg md:text-xl font-medium mb-2 dark:text-white  text-[#023E7D]">{t('pages.accounting.taxReports.vat.input')}</h3>
        <div className="overflow-x-auto">
          <table className="w-full border border-[#33415C] text-xs sm:text-sm">
            <thead>
              <tr className="border-b border-[#979DAC]">
      ...
      <div className="p-3 sm:p-4 md:p-6 border border-[#33415C] rounded-lg bg-[#0453A4]/10">
        <h3 className="text-base sm:text-lg md:text-xl font-medium mb-2 dark:text-white   text-[#023E7D]">{t('pages.accounting.taxReports.vat.summary')}</h3>
