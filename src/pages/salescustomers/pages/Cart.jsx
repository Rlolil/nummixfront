            ...
            <div className="flex gap-6">
                <div className="flex flex-col gap-4 w-2/3">
                    <div className="w-full flex gap-4 border-1 border-zinc-300 rounded-xl p-6">
                        <input
                            type="text"
                            placeholder="Ştrixkod oxuyun və ya daxil edin..."
                            className="w-full rounded-lg border bg-zinc-100 border-gray-300 px-4"
                        />
                        <button className="btn btn-neutral rounded-lg">Əlavə Et</button>
                    </div>
                    <BodyCard
                        title={null}
                        child={
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex flex-col gap-2">
                                        <div className="flex justify-between">
                                            <p className="text-zinc-500">Ara Cəmi:</p>
                                            <p>₼245.00</p>
                                        </div>
                                        <div className="flex justify-between">
                                            <p className="text-zinc-500">ƏDV (18%):</p>
                                            <p>₼44.28</p>
                                        </div>
                                    </div>
                                    <div className="flex justify-between">
                                        <p className="text-lg">YEKUN:</p>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button className="btn btn-neutral rounded-lg">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            class="lucide lucide-banknote h-4 w-4 mr-2"
                                            ariaHidden="true"
                                        >
