      ...
      ...assets.map((asset) =>
        [
          ...
          (
            ...
            parseFloat(asset.currentValue.replace(/,/g, ""))
          ).toFixed(2),
          asset.status,
        ].join(",")
      ),
...
${assets
  .map((asset) => {
    ...
    const depreciationRate = (
      (depreciation / parseFloat(asset.initialValue.replace(/,/g, ""))) *
      100
    ).toFixed(2);
    return `
${asset.name}
...
`;
  ...
  return (
    <div className="min-h-screen dark:bg-[#001233] dark:text-white bg-[#FFFFFF] p-8 ml-[0px] sm:ml-[100px]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tabs */}
        <div className="flex gap-2 mb-6 bg-white dark:bg-[#001233] dark:text-white rounded-lg p-2 shadow-sm border border-[#979DAC]">
          <button
            onClick={() => setActiveTab("management")}
            className={`flex items-center gap-2 px-4 py-2 rounded-md transition-all ${
              activeTab === "management"
                ? "bg-[#0466CB] text-white shadow-md  dark:text-white"
                : "text-[#001233] hover:bg-[#979DAC]/10 dark:text-white"
            }`}
          >
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="bg-white dark:bg-[#001233] dark:text-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow border border-[#979DAC]"
                >
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-[#5C677D] text-sm font-medium">
                      {stat.title}
                    </span>
                    <div className="text-[#0466CB] dark:text-white">
                      {stat.icon}
                    </div>
                  </div>
                  <div className="mb-1">
                    <span className="text-3xl font-bold dark:text-white text-[#023E7D]">
                      {stat.value}
                    </span>
                    {index < 3 && (
                      <span className="text-xl text-[#7D8597] ml-1">₼</span>
                    )}
                  </div>
                  ...
                  <div className="ml-8 space-y-3">
                    {categories.map((cat, index) => (
                      <div key={index} className="flex items-center gap-3">
                        ...
                        />
                        <span className="text-sm dark:text-white text-[#001233]">
                          {cat.name} ({cat.count})
                        </span>
                      </div>
                    ))}
              ...
              <div className="bg-white  dark:bg-[#001233] rounded-lg p-6 shadow-md border border-[#979DAC]">
                ...
                <div className="h-80 flex items justify-between gap-4 pl-12 pb-3 relative">
                  ...
                  {branchData.map((branch, index) => (
                    <div
                      key={index}
                      className="flex-auto flex-col items-center"
                    >
                      <div
                      ...
                      <span className="text-xs dark:text-white text-[#001233] text-center mt-2 whitespace-nowrap">
                        {branch.name}
                      </span>
                    </div>
                  ))}
        ...
        {activeTab === "assets" && (
          <div className="bg-white dark:bg-[#001233] rounded-lg shadow-md border border-[#979DAC]">
            {/* Search Bar */}
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="bg-white dark:bg-[#001233]  dark:text-white divide-y divide-[#979DAC]">
                  {filteredAssets.map((asset, index) => {
                    ...
                    return (
                      <tr
                        key={index}
                        className="hover:bg-[#979DAC]/10 transition-colors"
                      >
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#001233] font-medium">
                          {asset.invNo}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#001233]">
                          {asset.name}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#5C677D]">
                          {asset.category}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#5C677D]">
                          {asset.account}
                        </td>
                        <td className="px-6 py-4 text-sm dark:text-white text-[#5C677D]">
                          {asset.location}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#023E7D] font-semibold">
                          {asset.initialValue} ₼
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#023E7D] font-semibold">
                          {asset.currentValue} ₼
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-[#5C677D] relative">
                          <button
                            className="hover:text-[#001233] dark:hover:opacity-80"
                            onClick={() =>
                              setActiveMenuId(isOpen ? null : index)
                            }
                          >
                          ...
                          {isOpen && (
                            <div
                              ref={menuRef}
                              className="absolute right-0 mt-2 w-32 bg-white dark:bg-[#001233] shadow-lg rounded-md border border-[#979DAC] z-50"
                            >
                              <button
      ...
      {showAddModal && (
        ...
        >
          <div
            className="bg-white dark:bg-[#001233] dark:text-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
          ...
          >
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white mb-2">
                    {t("pages.assets.form.inventoryNo")}{" "}
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-[#001233] dark:border-gray-600 dark:focus:ring-indigo-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-[#001233] dark:border-gray-600 dark:focus:ring-indigo-500"
                  >
                    <option value="">
                      {t("pages.assets.form.selectCategory")}
                    </option>
                    <option value="Kompüter avadanlığı">
                      {t("pages.assets.form.categoryOptions.computerEquipment")}
                    </option>
                    <option value="Nəqliyyat vasitələri">
                      {t("pages.assets.form.categoryOptions.vehicles")}
                    </option>
                    <option value="Ofis avadanlığı">
                      {t("pages.assets.form.categoryOptions.officeEquipment")}
                    </option>
                    <option value="Əmlak">
                      {t("pages.assets.form.categoryOptions.property")}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white text-gray-700 mb-2">
                    {t("pages.assets.form.accountCode")}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <select
                  ...
                  >
                    <option value="111">
                      {t("pages.assets.form.accountOptions.111")}
                    </option>
                    <option value="112">
                      {t("pages.assets.form.accountOptions.112")}
                    </option>
                    <option value="113">
                      {t("pages.assets.form.accountOptions.113")}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white text-gray-700 mb-2">
                    {t("pages.assets.form.purchaseDate")}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white mb-2">
                    {t("pages.assets.form.initialValue")}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
                    ...
                    className="w-full px-3 py-2 border border-[#979DAC] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0466CB] bg-white dark:bg-[#001233] dark:border-gray-600 dark:focus:ring-[#0466CB]"
                  />
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white mb-2">
                    {t("pages.assets.form.residualValue")}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white mb-2">
                    {t("pages.assets.form.depreciationMethod")}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium dark:text-white mb-2">
                    {t("pages.assets.form.usefulLifeMonths")}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  ...
                  >
                    <option value="">
                      {t("pages.assets.form.selectLocation")}
                    </option>
                    <option value="Bakı Ofisi">
                      {t("pages.assets.form.locationOptions.bakuOffice")}
                    </option>
                    <option value="Sumqayıt filialı">
                      {t("pages.assets.form.locationOptions.sumgaitBranch")}
                    </option>
                    <option value="Gəncə filialı">
                      {t("pages.assets.form.locationOptions.ganjaBranch")}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="">
                      {t("pages.assets.form.selectBranch")}
                    </option>
                    <option value="IT Şöbəsi">
                      {t("pages.assets.form.branchOptions.it")}
                    </option>
                    <option value="Mühasibatlıq">
                      {t("pages.assets.form.branchOptions.accounting")}
                    </option>
                    <option value="Satış şöbəsi">
                      {t("pages.assets.form.branchOptions.sales")}
                    </option>
                    <option value="İnsan resursları">
                      {t("pages.assets.form.branchOptions.hr")}
                    </option>
                  </select>
                </div>
              ...
              <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-[#979DAC]">
                <button
                  onClick={() => setShowAddModal(false)}
                  className="px-4 py-2 border border-[#979DAC] dark:text-white dark:hover:bg-[#002855] rounded-lg text-[#001233] hover:bg-[#FFFFFF] transition-colors"
                >
      ...
      {showCategoryReport && (
        ...
        >
          <div
            className="bg-white dark:bg-[#001233] dark:text-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sticky top-0 bg-white dark:bg-[#001233] border-b border-[#979DAC] px-6 py-4 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-[#023E7D] dark:text-white">
                {t("pages.assets.categoryReportModal.title")}
              </h2>
              <button
                onClick={() => setShowCategoryReport(false)}
            ...
            <div className="p-6">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#002855] dark:bg-[#001233] border-b-2 border-[#33415C]">
                    <tr>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.categoryReportModal.headers.category")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t(
                          "pages.assets.categoryReportModal.headers.assetCount"
                        )}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.categoryReportModal.headers.initial")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.categoryReportModal.headers.current")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t(
                          "pages.assets.categoryReportModal.headers.depreciation"
                        )}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.categoryReportModal.headers.percent")}
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#979DAC]">
                    {categoryReportData.map((cat, index) => {
                      const percentage = (
                        (cat.depreciation / cat.totalValue) *
                        100
                      ).toFixed(2);
                      return (
                        <tr key={index} className="hover:bg-[#FFFFFF] dark:hover:bg-[#002855]">
                          <td className="px-6 py-4 text-sm text-[#001233] dark:text-white font-medium">
                            {cat.name}
                          </td>
                          <td className="px-6 py-4 text-sm text-[#5C677D] dark:text-gray-400">
                            {cat.count}
                          </td>
                          <td className="px-6 py-4 text-sm text-[#001233] dark:text-white">
                            {cat.totalValue.toLocaleString()} ₼
                          </td>
                          <td className="px-6 py-4 text-sm text-[#001233] dark:text-white">
                            {cat.currentValue.toLocaleString()} ₼
                          </td>
                          <td className="px-6 py-4 text-sm text-[#001233] dark:text-white">
                            {cat.depreciation.toLocaleString()} ₼
                          </td>
                          <td className="px-6 py-4 text-sm text-[#5C677D] dark:text-gray-400">
                            {percentage}%
                          </td>
                    ...
                    <tr className="bg-[#001845] font-semibold">
                      <td className="px-6 py-4 text-sm text-white">
                        {t("pages.assets.categoryReportModal.total")}
                      </td>
                      <td className="px-6 py-4 text-sm text-white">
                        {categoryReportData.reduce(
                      ...
                      <td className="px-6 py-4 text-sm text-white">
                        {categoryReportData
                          .reduce((sum, cat) => sum + cat.currentValue, 0)
                          .toLocaleString()}{" "}
                        ₼
                      </td>
                      <td className="px-6 py-4 text-sm text-white">
                        {categoryReportData
                          .reduce((sum, cat) => sum + cat.depreciation, 0)
                          .toLocaleString()}{" "}
                        ₼
                      </td>
                      <td className="px-6 py-4 text-sm text-white">
      ...
      {showBranchReport && (
        ...
        >
          ...
          >
            <div className="sticky top-0 bg-white dark:bg-[#001233] border-b border-[#979DAC] px-6 py-4 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-[#023E7D] dark:text-white">
                {t("pages.assets.branchReportModal.title")}
              </h2>
              <button
                onClick={() => setShowBranchReport(false)}
                className="text-[#7D8597] hover:text-[#001233] dark:hover:text-white"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#002855] border-b-2 border-[#33415C]">
                    <tr>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.branchReportModal.headers.location")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.branchReportModal.headers.assetCount")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.branchReportModal.headers.initial")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.branchReportModal.headers.current")}
                      </th>
                      <th className="px-6 py-3 text-left text-sm font-semibold text-white">
                        {t("pages.assets.branchReportModal.headers.share")}
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#979DAC]">
                    {branchReportData.map((branch, index) => {
                      const totalValue = branchReportData.reduce(
                        (sum, b) => sum + b.totalValue,
                        0
                      );
                      const share = (
                        (branch.totalValue / totalValue) *
                        100
                      ).toFixed(2);
                      return (
                        <tr key={index} className="hover:bg-[#FFFFFF] dark:hover:bg-[#002855]">
                          <td className="px-6 py-4 text-sm text-[#001233] font-medium dark:text-white">
                            {branch.name}
                          </td>
                          <td className="px-6 py-4 text-sm text-[#5C677D] dark:text-gray-400">
                            {branch.count}
                          ...
                          <td className="px-6 py-4 text-sm text-[#001233] dark:text-white">
                            {branch.currentValue.toLocaleString()} ₼
                          </td>
                          <td className="px-6 py-4 text-sm text-[#5C677D] dark:text-gray-400">
                            {share}%
                          </td>
                    ...
                    <tr className="bg-[#001845] font-semibold">
                      <td className="px-6 py-4 text-sm text-white">
                        {t("pages.assets.branchReportModal.total")}
                      </td>
                      <td className="px-6 py-4 text-sm text-white">
